...
class MuscleMassDetailsScreen extends StatefulWidget {
  const MuscleMassDetailsScreen({
    Key? key,
  }) : super(key: key);

  @override
  State<MuscleMassDetailsScreen> createState() => _MuscleMassDetailsScreen();
}

class _MuscleMassDetailsScreen extends State<MuscleMassDetailsScreen> {
  int selectedIndex = 0;
  final String iconPath = "assets/icons/mnu_bmm_l.webp";
                ...
                const ColoredDataRangeIndicator(
                  ...
                  items: [
                    ColoredDataRangeWidget(
                      ...
                      inRange: false,
                      rangeDescription: "Below 29.1",
                      rangeName: "Low",
                    ),
                    ColoredDataRangeWidget(
                      color: Colors.green,
                      inRange: false,
                      rangeDescription: "B/w 29.1 & 34.7",
                      rangeName: "Normal",
                    ),
                    ColoredDataRangeWidget(
                      color: Colors.red,
                      inRange: true,
                      rangeDescription: "Above 34.7",
                      rangeName: "High",
                    ),
                  ],
                ),
